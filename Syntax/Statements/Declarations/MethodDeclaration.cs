...
public sealed record MethodDeclaration(Token Identifier, ReadOnlyCollection<Token> Parameters, BlockStatement Body) : FunctionDeclaration(Identifier, Parameters, Body)
{
    /// <inheritdoc />
